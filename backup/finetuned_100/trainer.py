...
class Trainer:
    ...
    def process_batch(self, inputs):
        ...
        #    HS add
        if self.opt.model_name == "self_100":
            losses = self.self_sup_loss(inputs, losses, True, False, False)
        elif self.opt.model_name == "self_010":
            losses = self.self_sup_loss(inputs, losses, False, True, False)
        elif self.opt.model_name == "self_001":
            losses = self.self_sup_loss(inputs, losses, False, False, True)
        elif self.opt.model_name == "self_011":
            losses = self.self_sup_loss(inputs, losses, False, True, True)
        elif self.opt.model_name == "self_101":
            losses = self.self_sup_loss(inputs, losses, True, False, True)
        elif self.opt.model_name == "self_110":
            losses = self.self_sup_loss(inputs, losses, True, True, False)
        elif self.opt.model_name == "self_111":
            losses = self.self_sup_loss(inputs, losses, True, True, True)
        else:
            pass
    ...
    def self_sup_loss(self, inputs, losses, loss1, loss2, loss3):
            # HS add @@@@@@@@@@@@@@@@
            param_loss_ssl = 0.01
            param_kd_loss = 10
            param_loss_sp = 300
